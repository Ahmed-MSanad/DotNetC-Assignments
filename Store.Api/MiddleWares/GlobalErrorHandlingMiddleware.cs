...
namespace Store.Api.MiddleWares
{
    public class GlobalErrorHandlingMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext httpContext)
        {
            ...
            {
                _logger.LogError($"Something went Wrong within the GlobalErrorHandlingMiddleware -> {ex}");
        ...
        private int HandleValidationException(ValidationException validationException, ErrorDetails errorDetails)
        {
