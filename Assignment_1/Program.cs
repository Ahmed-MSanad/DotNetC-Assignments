...
namespace Assignment_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Student[] students = {
            //    new Student() { FName = "Ahmed", LName = "Sanad", Address = "US", Age = 22 },
            //    new Student() { FName = "Sara", LName = "Mahmoud", Address = "Canada", Age = 20 },
            //    new Student() { FName = "Mohamed", LName = "Ali", Address = "UK", Age = 25 },
            //    new Student() { FName = "Aisha", LName = "Hassan", Address = "Egypt", Age = 21 },
            //    new Student() { FName = "Omar", LName = "Youssef", Address = "Australia", Age = 23 },
            //    new Student() { FName = "Laila", LName = "Khaled", Address = "Germany", Age = 24 }
            //};
            ...
            //Course[] courses = {
            //    new Course() { Name = "Introduction to Programming", Duration = 40, Description = "Learn the basics of programming." },
            //    new Course() { Name = "Web Development Fundamentals", Duration = 60, Description = "Build websites using HTML, CSS, and JavaScript." },
            //    new Course() { Name = "Data Science with Python", Duration = 80, Description = "Analyze data and build machine learning models." },
            //    new Course() { Name = "Mobile App Development", Duration = 70, Description = "Create mobile apps for iOS and Android." },
            //    new Course() { Name = "Database Management", Duration = 50, Description = "Learn to design and manage databases." }
            //};
            ...
            //    new Instructor() { Name = "Dr. Ahmed Mahmoud", Bouns = 500.00, Salary = 8000.00, Address = "123 Main St, Cairo", HourRate = 50.00 },
            //    new Instructor() { Name = "Prof. Sara Ali", Bouns = 300.00, Salary = 7000.00, Address = "456 Elm St, Alexandria", HourRate = 45.00 },
            //    new Instructor() { Name = "Eng. Mohamed Hassan", Bouns = 100.00, Salary = 5500.00, Address = "789 Oak St, Giza", HourRate = 40.00 },
            //    new Instructor() { Name = "Ms. Laila Youssef", Bouns = 400.00, Salary = 7500.00, Address = "101 Pine St, Mansoura", HourRate = 55.00 },
            //    new Instructor() { Name = "Mr. Omar Khaled", Bouns = 100.00, Salary = 5500.00, Address = "202 Cedar St, Tanta", HourRate = 35.00 }
            //};
            ...
            //    new Course_Ins() { Course_Id = 1, Ins_Id = 1, Evaluate = "Excellent" },
            //    new Course_Ins() { Course_Id = 3, Ins_Id = 1, Evaluate = "Good" },
            //    new Course_Ins() { Course_Id = 1, Ins_Id = 3, Evaluate = "Satisfactory" },
            //    new Course_Ins() { Course_Id = 4, Ins_Id = 4, Evaluate = "Needs Improvement" },
            //    new Course_Ins() { Course_Id = 5, Ins_Id = 5, Evaluate = "Outstanding" }
            //};
            ...
            //    new Stud_Course() { Course_Id = 1, Stud_Id = 2, Grade = 92.5 },
            //    new Stud_Course() { Course_Id = 1, Stud_Id = 3, Grade = 85.0 },
            //    new Stud_Course() { Course_Id = 3, Stud_Id = 4, Grade = 78.3 },
            //    new Stud_Course() { Course_Id = 3, Stud_Id = 5, Grade = 95.8 },
            //    new Stud_Course() { Course_Id = 4, Stud_Id = 6, Grade = 60.0 },
            //    new Stud_Course() { Course_Id = 5, Stud_Id = 2, Grade = 100.0 }
            //};
